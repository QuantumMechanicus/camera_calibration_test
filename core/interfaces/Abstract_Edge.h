...
namespace graph {
    ...
    class AbstractEdge {
    protected:
        typename TVertex::NodeLabel start_vertex_label_;
        typename TVertex::NodeLabel end_vertex_label_;

        std::shared_ptr<std::map<typename TVertex::NodeLabel, TVertex>> ptr_to_list_of_vertices_{};

    public:

        using VertexMap = std::map<typename TVertex::NodeLabel, TVertex>;
        ...
        AbstractEdge(typename TVertex::NodeLabel st_vertex, typename TVertex::NodeLabel end_vertex,
                     std::shared_ptr<std::map<typename TVertex::NodeLabel, TVertex>> ptr_to_list_of_vertices) :
        ...
        const std::shared_ptr<std::map<typename TVertex::NodeLabel, TVertex>> &getVertexListPointer() const {
